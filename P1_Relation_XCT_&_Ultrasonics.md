...
<video src="images/P1_imgs/mini_video ultrasonidos_confondo.mp4" controls="controls" style="width: 49%;"> </video> <video src="images/P1_imgs/c4_rendered.mp4" controls="controls" style="width: 49%;">
